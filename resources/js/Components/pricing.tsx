...
export function PricingTab(props: PricingTabProps) {
  return (
    <div className={`h-full `}>
      <div className="relative flex flex-col h-full p-6 bg-black border shadow rounded-2xl border-white/30 shadow-black/80">
        {props.popular && (
        ...
        <div className="mb-5">
          <div className="mb-1 font-semibold text-white/70">{props.planName}</div>
          <div className="inline-flex items-baseline mb-2">
            <span className="text-3xl font-bold text-white/70">$</span>
            <span className="text-4xl font-bold text-white/50">{props.yearly ? props.price.yearly : props.price.monthly}</span>
            <span className="font-medium text-white/70">/mo</span>
          </div>
          <div className="mb-5 text-sm text-white/70">{props.planDescription}</div>
        ...
        <ul className="space-y-3 text-sm text-slate-400 grow">
